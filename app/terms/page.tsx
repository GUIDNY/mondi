  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", fontFamily: "Rubik,sans-serif", lineHeight: 1.8 }}>
      ...
      {[
        {
          title: "1. השירות",
          body: `MatchMate היא אפליקציית ניחושים חינמית לאליפות כדורגל 2026. המשתמשים מנחשים תוצאות משחקים, צוברים נקודות, ומתחרים אחד עם השני. האפליקציה אינה כרוכה בהימורים בכסף אמיתי בשום צורה.`,
        },
        {
          title: "2. גיל מינימלי",
        ...
        },
        {
          ...
          body: `MatchMate מסופקת "כמו שהיא" ללא אחריות מכל סוג. אנו לא אחראים לשגיאות בתוצאות המשחקים, לניתוקים, או לאובדן נתונים. הנקודות הן וירטואליות ואין להן ערך כספי.`,
        },
        {
